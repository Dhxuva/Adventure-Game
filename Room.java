...
public class Room implements Serializable {
    ...
    public String getObjectString() {
        ...
        int i;
        for(i=0; i<this.objectsInRoom.size(); i++){
            if (i == this.objectsInRoom.size()-1){
                objectString.append(this.objectsInRoom.get(i).getDescription());
            }else{
                objectString.append(this.objectsInRoom.get(i).getDescription()).append(",");
            }
        }
...
//        return null; //replace this!
    ...
    public String getCommands() {
        ...
        int i;
        for(i=0; i<this.motionTable.passageTable.size(); i++){
            if (i == this.motionTable.passageTable.size()-1){
                commandString.append(this.motionTable.passageTable.get(i).getDirection());
            }else{
                commandString.append(this.motionTable.passageTable.get(i).getDirection()).append(",");
            }
        }
